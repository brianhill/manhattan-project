...
* Friday, Feb. 3 &mdash; Hand out copies of each other's mock journal entries to read for Tuesday &mdash; Do we need to discuss the droplet model of fission to have a bit better of an understanding why a large nucleus might be prompted to suddenly fall apart into two (unequal) halves rather than to just slowly alpha- and beta-decay its way toward stability, or was the billiard ball dropping into a pocket enough? &mdash; While we are finishing Chapter 3 (Sections 3.7 and 3.8), we need to spend more time than we have so far on Sections 3.2 to 3.6
